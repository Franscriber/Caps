...
<div class="wrapper">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="edit-company.php"><i class="fa fa-desktop"></i> My Company</a></li>
                  ...
                  <li><a href="job-applications.php"><i class="fa fa fa-pencil"></i> Job Application</a></li>
                  <li><a href="mailbox.php"><i class="fa fa-envelope"></i> Mailbox</a></li>
                  <li><a href="settings.php"><i class="fa fa-gear"></i> Settings</a></li>
                  <li><a href="resume-database.php"><i class="fa fa-folder-open"></i> Resume Database</a></li>
              ...
              <form action="update-company.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    ...
                    <?php if($row['logo'] != "") { ?>
                    <img src="../uploads/logo/<?php echo $row['logo']; ?>" class="img-responsive" style="max-height: 300px; max-width: 300px;">
                    <?php } ?>
                  </div>
                </div>
                    <?php
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2024-2025 <a href="learningfromscratch.online">PUP Alumet</a>.</strong> All rights
    reserved.
    </div>
  </footer>
