...
<div class="wrapper">
              ...
              <div class="table-responsive mailbox-messages">
                <table id="example1" class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td><button class="delete-btn"><a href="delete.php?id=<?php echo $row['id_mailbox']; ?>">Delete</a></button></td>
                  </tr>
                  <?php
                      }
                    }
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; PUP Alumnet <a href="learningfromscratch.online">PUP Alumnet</a>.</strong> All rights
    reserved.
    </div>
  </footer>
