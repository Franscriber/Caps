        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="city" name="city" placeholder="Province">
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="state" name="state" placeholder="Municipality">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="file" name="resume" class="form-control input-lg" required>
              </div>
            </div>
          </form>
