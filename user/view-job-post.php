      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <hr>
            <div>
              <p><span class="margin-right-10"><i class="fa fa-location-arrow text-black"></i> <?php echo $row['city']; ?></span> <i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></p>              
            </div>
            <div>
            ...
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4"><a href="create-mail.php"><i class="fa fa-envelope"></i> Email</a></div>
                </div>
              </div>
            </div>
          </div>
