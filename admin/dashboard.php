...
<head>
  ...
  <title>PUP Alum Net</title>
  <link rel="icon" href="../img/PUPAlumnetLogo.jpg" type="image/x-icon">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="companies.php"><i class="fa fa-building"></i> Job Recruiters</a></li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Active Job Recruiters Registered</span>
                    <?php
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-red"><i class="ion ion-briefcase"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">Pending Job Recruites Approval</span>
                    <?php
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-red"><i class="ion ion-person-stalker"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">Pending Job Seekers Confirmation</span>
                    <?php
