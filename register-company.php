...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>PUP</b> <b  style="color:yellow;">Alumnet</b></span>
    </a>
        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="contactno" placeholder="Phone Number" minlength="11" maxlength="11" autocomplete="on" onkeypress="return validatePhone(event);" required>
              </div>
              <div class="form-group">
              ...
              <div id="cityDiv" class="form-group" style="display: none;">
                <input class="form-control  input" type="text" id="city" name="city" required>
